...
function setup() {
	...
	bob1 = Bodies.circle(320,500,25,bob_options);
	World.add(world,bob1);

	bob2 = Bodies.circle(370,500,25,bob_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(420,500,25,bob_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(470,500,25,bob_options);
	World.add(world,bob4);

	bob5 = Bodies.circle(520,500,25,bob_options);
